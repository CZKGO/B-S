...
/**
 * Created by 陈忠凯 on 2017/5/16.
 */

public class AddAthleticActivity extends BaseFragmentActivity {
    ...
    public void getData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                DBOpenHelper helper = new DBOpenHelper(AddAthleticActivity.this);
    ...
    private void initView() {
        ...
        spwDate = new SpinerPopWindow(AddAthleticActivity.this, typeChose);
...
//        tvChoose.setText();
    ...
    private boolean checkEvent(int type) {
        ...
        if (type > CHECK_NAME && StringUtil.isEmpty(etName.getText().toString())) {
            doEvent = false;
            ToastUtil.showShortToast(AddAthleticActivity.this, getResources().getString(R.string.please_input_food_name));
            ...
            doEvent = false;
            ToastUtil.showShortToast(AddAthleticActivity.this, getResources().getString(R.string.please_input_food_material));
            ...
            doEvent = false;
            ToastUtil.showShortToast(AddAthleticActivity.this, getResources().getString(R.string.please_input_blood_sugar_level_before_dining));
            ...
            doEvent = false;
            ToastUtil.showShortToast(AddAthleticActivity.this, getResources().getString(R.string.please_input_blood_sugar_level_after_dining));
