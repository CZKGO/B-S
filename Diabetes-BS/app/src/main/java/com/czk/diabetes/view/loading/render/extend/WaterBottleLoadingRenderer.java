package com.czk.diabetes.view.loading.render.extend;
...
import com.czk.diabetes.view.loading.render.LoadingRenderer;
...
public class WaterBottleLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mStrokeWidth = DimensUtil.dpTopx(context, DEFAULT_STROKE_WIDTH);
