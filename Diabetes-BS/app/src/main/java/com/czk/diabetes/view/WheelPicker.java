...
public class WheelPicker extends View implements Runnable{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isDebug)
            LogUtil.i(TAG, "Wheel's content size is (" + resultWidth + ":" + resultHeight + ")");
        ...
        if (isDebug)
            LogUtil.i(TAG, "Wheel's size is (" + resultWidth + ":" + resultHeight + ")");
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        if (isDebug)
            LogUtil.i(TAG, "Wheel's drawn rect size is (" + mRectDrawn.width() + ":" +
    ...
    public void run() {
        ...
        if (mScroller.isFinished() && !isForceFinishScroll) {
            ...
            if (isDebug)
                LogUtil.i(TAG, position + ":" + mData.get(position) + ":" + mScrollOffsetY);
