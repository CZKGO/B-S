...
public class AddValueActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        //主体
        tvValue = (TextView) findViewById(R.id.add_value);
        TextView tvDate = (TextView) findViewById(R.id.tv_date);
        tvDate.setText(TimeUtil.getYearMonthDay(currentTime));
        TextView tvTimeSlot = (TextView) findViewById(R.id.tv_time_slot);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        view.setTextColor(getResources().getColor(R.color.theme_color));
