...
public class FontIconDrawable extends Drawable {
    private static final String LogUtil_TAG = FontIconDrawable.class.getSimpleName();
    ...
    public void inflate(Context context, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        if (a == null) {
            LogUtil.w(FontIconDrawable.class.getSimpleName(), "inflate failed: r.obtainAttributes() returns null");
            return;
        }
        ...
        try {
            ...
            mAutoMirrored = a.getBoolean(R.styleable.FontIconDrawable_fontautoMirrored, false);
            mNeedMirroring = a.getBoolean(R.styleable.FontIconDrawable_fontneedMirroring, false);
        } finally {
            a.recycle();
        }
    ...
    static class MethodGetLayoutDirection {
        ...
        static {
            try {
                ...
                LogUtil.w(LogUtil_TAG, ex.getMessage());
            }
        }
